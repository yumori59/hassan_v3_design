...
設計入力として採用したのは **2 領域だけ** — ①**評価軸の 3 軸化** (~~契約ごとの編集・変更履歴・settings CRUD は増分 2 へ先送り~~ **2026-08-24 PV-D5**: 編集と CRUD の最小形は増分 1 へ前倒し・**変更履歴のみ増分 2**) ②**発散フローの v4 化** (レンズ 2 階層・自由記述質問・追加探索)。
