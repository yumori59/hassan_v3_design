...
**合計 151 エンドポイント** = 下表の 9 ドメイン **114 本** (**2026-08-24 に settings +2 — PV-D5**) + 認証・アカウント基盤
[auth-accounts.md](auth-accounts.md) の **37 本** (同書 §2。**2026-08-10 の AA-D-22 / AA-D-13 で 37 → 33**、
**2026-08-25 の AA-D-26 (契約管理 4 本の追加) で 33 → 37**)。
