...
同書の 403 は 13 本ある** — 系統と本数の SSOT は同書 §3.1 (**実測は `make check-endpoint-mapping` が正**。2026-08-10 の AA-D-22 で 10 → 8、**2026-08-25 の AA-D-26 で 8 → 12、2026-08-26 の AA-D-27 で 12 → 13**)。
**第 4 系統 (R-4 = 社内管理者の SuperAdmin 限定) も同書だけが持つ** — §2.4 の②契約管理 5 本が該当する。
...
**合計 152 エンドポイント** = 下表の 9 ドメイン **114 本** (**2026-08-24 に settings +2 — PV-D5**) + 認証・アカウント基盤
[auth-accounts.md](auth-accounts.md) の **38 本** (同書 §2。**2026-08-10 の AA-D-22 / AA-D-13 で 37 → 33**、
...
| 認証・アカウント基盤 | [auth-accounts.md](auth-accounts.md) | **38** | 0 | 0 | **13** |
| **合計** | — | **152** | **9** | **6** | **30** |
...
**認証・アカウント基盤の 13 本は別勘定** = 契約内管理者限定 8 本 (同書 §2.3) + **SuperAdmin 限定 5 本 (同 §2.4 の②契約管理。AA-D-26 / AA-D-27)**。**旧 SuperAdmin 限定の 1 本 (`POST /admin/admins/{id}/mfa/reset`) は AA-D-22 で消滅**。
